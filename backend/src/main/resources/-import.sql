...
insert into event (name, campus, start_Date, end_Date, details, folder, score) values ('Show do KISS','Hard Rock Live Florianopolis', '2023-04-25','2023-04-25','Show do KISS - Hard Rock Live Florianopolis', 'https://blackwaterviagens.com.br/wp-content/uploads/2023/01/kiss-turne.jpg', 0.0);
insert into event (name, campus, start_Date, end_Date, details, folder, score) values ('Show do Scorpions','Arena Petry - Florianopolis', '2023-09-28','2023-09-28','Show do SCORPIONS - Arena Petry ', 'https://www.makilacrowley.com.br/wp-content/uploads/ngg_featured/Cartaz_Excursoes_Scorpions_2019_Floripa_9375.jpg', 0.0);
