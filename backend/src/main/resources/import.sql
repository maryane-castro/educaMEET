 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 1','2022-03-10','2022-03-10','Detalhes Evento 1', 'Folder Evento 1', 0.0);
 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 2','2022-03-09','2022-03-10','Detalhes Evento 2', 'Folder Evento 2', 0.0);
 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 3','2022-03-08','2022-03-10','Detalhes Evento 3', 'Folder Evento 3', 0.0);
 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 4','2022-03-07','2022-03-10','Detalhes Evento 4', 'Folder Evento 4', 0.0);
 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 5','2022-03-06','2022-03-10','Detalhes Evento 5', 'Folder Evento 5', 0.0);
 insert into event (name, start_Date, end_Date, details, folder, score) values ('Evento 6','2022-03-11','2022-03-12','Detalhes Evento 6', 'Folder Evento 6', 0.0);
